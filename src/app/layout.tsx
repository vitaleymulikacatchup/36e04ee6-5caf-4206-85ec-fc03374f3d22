...
export const metadata: Metadata = {
  title: "Dream Agency - Professional Web Development Services",
  description: "Transform your digital presence with Dream Agency. We create custom websites, e-commerce solutions, and mobile apps that drive business growth.",
  keywords: "web development, website design, e-commerce, mobile apps, digital agency, custom websites",
  metadataBase: new URL("https://dreamagency.com"),
  alternates: {
    canonical: "https://dreamagency.com"
  },
  openGraph: {
    title: "Dream Agency - Professional Web Development Services",
    description: "Transform your digital presence with Dream Agency. We create custom websites, e-commerce solutions, and mobile apps that drive business growth.",
    siteName: "Dream Agency",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/7550581/pexels-photo-7550581.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Dream Agency development team"
    }]
  },
  twitter: {
    ...
    title: "Dream Agency - Professional Web Development Services",
    description: "Transform your digital presence with Dream Agency. We create custom websites, e-commerce solutions, and mobile apps that drive business growth.",
    images: ["https://images.pexels.com/photos/7550581/pexels-photo-7550581.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
